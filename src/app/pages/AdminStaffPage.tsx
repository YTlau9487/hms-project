    ...
    logoutTimerRef.current = setTimeout(() => {
      if (!warningShownRef.current) {
        ...
        toast.warning('Session expiring in 1 minute', {
          description: 'Please interact to stay logged in.',
          duration: 5000,
        });
      }
    }, WARNING_TIME);
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Manage hotel staff accounts</p>
            </div>
          </div>
          <div className="flex items-center gap-4 w-full sm:w-auto">
            ...
            <button
              ...
              className="cursor-pointer px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 hover:opacity-80 transition"
            >
              Logout
            </button>
          </div>
      ...
      <main className="max-w-6xl mx-auto p-4 sm:p-6">
        ...
        <div className="mb-6 flex justify-between items-center">
          <h2 className="text-lg font-semibold text-gray-900">Staff Accounts ({staff.length})</h2>
          <button
        ...
        {showCreateForm && (
          <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6 mb-6 shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Create New Staff Account</h3>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          {isLoading ? (
            <div className="p-12 text-center">
              ...
              <p className="text-gray-500 mt-3">Loading staff accounts...</p>
            </div>
          ) : staff.length === 0 ? (
            <div className="p-12 text-center">
              <Users className="w-12 h-12 mx-auto text-gray-300 mb-3" />
              <p className="text-gray-500">No staff accounts found</p>
              <p className="text-sm text-gray-400 mt-1">Create your first staff account to get started</p>
            </div>
          ) : (
            <>
              {/* Desktop Table */}
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0 space-y-1">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{member.phone || 'Not provided'}</p>
                        </div>
                        <div>
      ...
      <ConfirmationDialog
        ...
        description={`Are you sure you want to delete the staff account "${deleteConfirm?.name}"? This action cannot be undone.`}
        confirmText="Delete"
        variant="destructive"
        icon={Trash2}
      ...
      <ConfirmationDialog
        ...
        description={`Create a new staff account for "${createConfirm?.name}" (${createConfirm?.email})?`}
        confirmText="Create"
        variant="default"
        icon={UserPlus}
